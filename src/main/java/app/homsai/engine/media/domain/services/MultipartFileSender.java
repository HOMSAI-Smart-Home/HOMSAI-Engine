...
public class MultipartFileSender {
    ...
    public void serveResource() throws Exception {
        ...
        long lastModified = LocalDateTime
                .ofInstant(lastModifiedObj.toInstant(),
        ...
        if (contentType == null) {
            ...
            // Else, expect for images, determine content disposition. If content type is supported
            // by
            // the browser, then set to inline, else attachment which will pop a 'save as' dialogue.
            String accept = request.getHeader("Accept");
            disposition = accept != null && HttpUtils.accepts(accept, contentType) ? "inline"
                    : "attachment";
        }
