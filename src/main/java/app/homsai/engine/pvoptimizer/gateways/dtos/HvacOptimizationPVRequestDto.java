package app.homsai.engine.pvoptimizer.gateways.dtos;
...
public class HvacOptimizationPVRequestDto {
    ...
    private List<OptimizerHVACDeviceDto> hvacDevices;
    ...
    public List<OptimizerHVACDeviceDto> getHvacDevices() {
        return hvacDevices;
    }

    public void setHvacDevices(List<OptimizerHVACDeviceDto> hvacDevices) {
